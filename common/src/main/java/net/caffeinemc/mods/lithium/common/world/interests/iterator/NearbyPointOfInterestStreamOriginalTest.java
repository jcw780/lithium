 ...
 */
public class NearbyPointOfInterestStreamOriginalTest extends Spliterators.AbstractSpliterator<PoiRecord> {
    ...
    public NearbyPointOfInterestStreamOriginalTest(Predicate<Holder<PoiType>> typeSelector,
