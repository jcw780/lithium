...
public class FixedContiguousRegionBitset extends FixedContiguousRegionType{
    public final BitSet data;

    public FixedContiguousRegionBitset(int x0, int x1, int y0, int y1, int z0, int z1){
    ...
    public void set(int x, int y, int z, boolean input){
