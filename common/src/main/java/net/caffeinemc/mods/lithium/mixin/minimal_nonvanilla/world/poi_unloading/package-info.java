@MixinConfigOption(
        description = "Unload non-portal forced POIs. " +
                ...
                "However, this will only be detectable during the first portal load into an area with valid POI sections that were loaded by non-portal means and then unloaded.",
        depends = {
