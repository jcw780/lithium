...
val MINECRAFT_VERSION by extra { "1.21.9-rc1" } //MUST manually update fabric.mod.json and neoforge.mods.toml
val NEOFORGE_VERSION by extra { "21.8.0-beta" }
...
// https://semver.org/
val MOD_VERSION by extra { "0.18.1" }
